...
- **[to-issues](./skills/engineering/to-issues/SKILL.md)** - 用 vertical slices 把计划、spec 或 PRD 拆成可独立领取的 issue tracker issues。
- **[to-prd](./skills/engineering/to-prd/SKILL.md)** - 把当前对话整理成 PRD 并发布到 issue tracker。不做访谈，只综合已经讨论过的内容。
